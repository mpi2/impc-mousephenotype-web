...
const PublicationsPage = () => {
  ...
  const { data } = useQuery({
    ...
    select: (aggregationData: AggregationData) => {
      ...
      const publicationsByGrantsChart = allGrantsData.filter(
      ...
      return {
        ...
        grantsChart: {
          ...
          data: {
            labels: publicationsByGrantsChart.map(
              (pubCount) => pubCount.agency
            ),
            datasets: [
              {
                label: "Publications",
                data: publicationsByGrantsChart.map(
                  (pubCount) => pubCount.count
                ),
              },
            ],
          },
