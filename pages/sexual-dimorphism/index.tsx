  ...
  return (
    <>
      ...
      <Container className="page" style={{lineHeight: 2}}>
          ...
          <Container>
            <Row>
              <Col xs={12}>
                ...
                <ul>
                  <li>
                    Press releases: <a className="primary link" href="http://www.bbc.co.uk/programmes/b08vwn6w">BBC Radio 4 - "inside Science"</a>&nbsp;|&nbsp;
                    <a className="primary link" href="https://www.newscientist.com/article/2138671-research-on-male-animals-prevents-women-from-getting-best-drugs/">New Scientist</a>&nbsp;|&nbsp;
                    <a className="primary link" href="http://www.dailymail.co.uk/wires/reuters/article-4640316/Sexual-equality-medical-research-long-overdue-study-finds.html">Daily Mail</a>&nbsp;|&nbsp;
                    <a className="primary link" href="https://www.sciencedaily.com/releases/2017/06/170626124505.htm">Science Daily</a>&nbsp;|&nbsp;
                    <a className="primary link" href="http://fortune.com/2017/06/26/sexual-bias-medical-research/">Fortune</a>&nbsp;|&nbsp;
                    <a className="primary link" href="//www.mousephenotype.org/news/study-of-unprecedented-size-reveals-how-sex-blindspot-could-misdirect-medical-research/">IMPC</a>&nbsp;|&nbsp;
                    <a className="primary link" href="http://www.ebi.ac.uk/about/news/press-releases/sexual-dimorphism-dilemma">EMBL-EBI</a>&nbsp;|&nbsp;
                    <a className="primary link" href="http://www.sanger.ac.uk/news/view/study-reveals-how-sex-blindspot-could-misdirect-medical-research">Sanger</a>
                  </li>
                  <li>
                    <a className="primary link" href="https://zenodo.org/record/260398#.WVIkChPys-c">Supporting material to enable replicable analysis</a>
                  </li>
                  <li>
                    <a className="primary link" href="https://www.nature.com/articles/ncomms15475">Publication: Nature Communications 26 June 2017</a>
                  </li>
                </ul>
              </Col>
            </Row>
        ...
        <Card>
          <h1><strong>Sexual dimorphism in 14,250 wildtype mice</strong></h1>
          <Row>
            <Col xs={6}>
        ...
        <Card>
          <h1><strong>Sexual dimorphism in 2,186 knockout mouse strains</strong></h1>
          <Row>
            <Col xs={6}>
              <div style={{ position: 'relative', width: '100%', height: '300px' }}>
                {data && (
          ...
          <Row>
            <Col>
              <p>
                The impact of sex on phenotypes of knockout C57BL/6N mouse lines measured using
                the IMPC adult phenotype pipeline at ten global research centers.
                Only strains with an abnormal phenotype attributable to the
                knockout allele (i.e genotype effect) were included.
              </p>
