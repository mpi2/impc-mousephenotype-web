    ...
    <>
      <Card>
        <div>
          ...
          <h1>
            <strong>Gross Morphology Embryo E14.5-E15.5 / Embryo Size</strong>
          </h1>
        </div>
      ...
      <Row>
        <Col lg={12}>
          <Card>
            <h2 className="primary">[Insert chart]</h2>
          </Card>
        </Col>
        <Col lg={6}>
          <Card>
          ...
          <Card>
            ...
            <SortableTable
              headers={[
                ...
                { width: 2, label: "Abnormal", disabled: true },
                { width: 2, label: "Normal", disabled: true },
                { width: 3, label: "Unobservable", disabled: true },
              ]}
            >
              <tr>
