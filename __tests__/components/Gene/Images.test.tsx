...
describe('Gene images component', () => {
  it('should display information', async () => {
    ...
    renderWithClient(<GeneImages gene={{ geneSymbol: 'Crlf3' }} />);
  ...
  it('should show an error message if the request fails', async () => {
    server.use(
      rest.get(`${API_URL}/api/v1/genes/MGI:1860086/images`, (req, res, ctx) => {
    ...
    expect(screen.getByRole('alert')).toHaveTextContent('There are no images available for Crlf3.');
  });
});