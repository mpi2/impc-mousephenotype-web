...
const datasets: Array<Dataset> = [
  {
    ...
    classificationTag:
      "Overally significant [level =  1e-04 , pvalue =  5.15607909123972e-06 ]; and with phenotype threshold value 1e-04 - different size as males greater",
    ...
    softWindowing: {
      ...
      minObsRequired: 560,
      numberOfDoe: 8,
      peaks: [14902, 14935, 14937, 14953, 14972, 15035, 15182, 15189],
  ...
  },
  {
    ...
    alleleSymbol: "Dbn1<tm1a(KOMP)Wtsi>",
    classificationTag:
      "Overally insignificant [level =  1e-04 , pvalue =  0.000116599744337975 ]; but with phenotype threshold value 1e-04 - different size as males greater",
    colonyId: "EPD0211_3_A05",
    dataType: "unidimensional",
    geneSymbol: "Dbn1",
    geneticBackground: "involves: C57BL/6N",
    ...
    softWindowing: {
      ...
      minObsRequired: 490,
      numberOfDoe: 7,
      peaks: [14897, 14930, 14946, 14964, 15028, 15177, 15184],
      shape: 5.42604853784322,
      threshold: 1.49011611938477e-7,
  ...
  },
  {
    ...
    alleleSymbol: "Dbn1<tm1a(KOMP)Wtsi>",
    classificationTag:
      "Overally significant [level =  1e-04 , pvalue =  3.1050294134749e-06 ]; and with phenotype threshold value 1e-04 - different size as males greater",
    colonyId: "EPD0211_3_A05",
    dataType: "unidimensional",
    geneSymbol: "Dbn1",
    geneticBackground: "involves: C57BL/6N",
    ...
    softWindowing: {
      ...
      minObsRequired: 560,
      numberOfDoe: 8,
      peaks: [14943, 14978, 14980, 14994, 15013, 15077, 15224, 15231],
  ...
  },
  {
    ...
    alleleSymbol: "Dbn1<tm1a(KOMP)Wtsi>",
    classificationTag:
      "Overally significant [level =  1e-04 , pvalue =  1.58218813239852e-05 ]; and with phenotype threshold value 1e-04 - different size as males greater",
    colonyId: "EPD0211_3_A05",
    dataType: "unidimensional",
    geneSymbol: "Dbn1",
    geneticBackground: "involves: C57BL/6N",
    ...
    softWindowing: {
      ...
      minObsRequired: 560,
      numberOfDoe: 8,
      peaks: [14930, 14963, 14964, 14981, 14998, 15061, 15211, 15217],
...
describe("Data comparison component", () => {
  it("renders deduplicated data", async () => {
    render(<DataComparison data={datasets} dataIsLoading={false} />);
